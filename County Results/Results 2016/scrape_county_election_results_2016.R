...
wd <- 'C:/Projects/Post Election/County Results/Results 2016'
setwd(wd)
...
# county name changed in 2015
state_county_fips[state_county_fips$county == 'shannon' & 
                    state_county_fips$abbr_state == 'sd'
