...
wd <- 'C:/Projects/Post Election/County Results/Results 2008'
setwd(wd)
...
grab_data <- function(state){
  url <- sprintf("http://townhall.com/election/2008/president/%s/county", state)
  # Try to grab
...
write.csv(res, "county_election_results_2008.csv", row.names=FALSE)
